bat0 = LOAD '/user/nthumma/data/20gb/bat_0.1.txt'  USING PigStorage(',') AS (oid:INT, val:INT);
...
STORE bat_updated INTO '/user/nthumma/data/20gb/bat_updated';

fs -rm -r -f /user/nthumma/data/20gb/bat_updated;
